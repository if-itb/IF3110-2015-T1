...
<body>
    <div id= "container">
        ...
        <div id="header">
            ...
            <p>Cannot find what you are looking for?<a class="orange_link" href="ask.php"> Ask here</a></p>        
        </div>
            ...
            <?php
                ...
                foreach($questions as $question){
                    ...
                    $middle = " <div class='middle'>
                                    <a href='question.php?id=". $question['q_id']."'>". $question['topic'] ."</a>
                    ...
                    $right = " <div class='right'>
                                ...
                                <a class='orange_link' href='ask.php?id=". $question['q_id'] . "'>edit</a> |
                                <a class='red_link red_link-".$question['q_id']."' href='' onclick ='return deleteConfirmation(".$question['q_id'].")' >delete</a>
                               </div>";
