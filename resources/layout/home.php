		...
		<?php
			...
			<tr>
				...
				<td>Answers</td>
					...
					echo "\t\t<p class='right'><b>asked by <a class='purple'>" . $question['name'] . "</a> | <a href='ask-question.php?id=" . $question['id'] . "' class='orange'>edit</a> | <a href='delete-question.php?id=" . $question['id'] . "' class='red'>delete</a></b></p>";
					echo "\n\t\t<br><hr>\n\n\t\t";
				}
			}
		?>
