...
public class EditQuestion extends HttpServlet {
  ...
  protected void processPostRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try (PrintWriter out = response.getWriter()) {
      ...
      DB.editQuestion(question, Integer.parseInt(request.getParameter("id")), request, response);      
    }
  }
  ...
  protected void processGetRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    DBHandler.Question DB = new DBHandler.Question();
    String q[] = DB.getQuestionByID(parameter1, request, response); 
    ...
    try (PrintWriter out = response.getWriter()) {
      ...
      out.println("	<div id=\"form\">\n" +
                  ...
                  "				<input type=\"hidden\" id=\"id\" name=\"id\" value=\"" + parameter1 + "\">\n" +
                  "				<input type=\"text\" id=\"name\" name=\"name\" placeholder=\"Name\" value=\"" + q[1] + "\">\n" +
                  "				<br>\n" +
                  "				<input type=\"text\" id=\"email\" name=\"email\" placeholder=\"Email@Email.com\" value=\"" + q[2] + "\">\n" +
                  "				<br>\n" +
                  "				<input type=\"text\" id=\"topic\" name=\"topic\" placeholder=\"Topic\" value=\"" + q[3] + "\">\n" +
                  "				<br>\n" +
                  "				<textarea id=\"content\" name=\"content\" placeholder=\"Content\" rows=\"5\" cols=\"40\">" + q[4] + "</textarea>\n" +
