...
<body>
	...
	<div id="div3">
		<div id="div4">
			...
			<div id="div5">
				<p>
					asked by <span id="idx_name"> <?php echo $question['Name'] ?> at <?php echo $question['Date'] ?> </span> | <span id="idx_edit"> <a id="a2" href="ask.php?q_id=<?php echo $question['Q_ID'] ?>"> edit </a> </span>
				</p>
			</div>
