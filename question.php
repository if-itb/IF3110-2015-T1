<html>
	...
	<body>
		...
		<table>
			<tr>
				<td class="VotesQA">
					<a onclick="VotesQUp(<?php echo $row["qid"] ?>,0)">
						<img src="img/vote-up.png">
					</a>
					<div id="VotesQ">
						<?php echo $row["votes"]?>
					</div>
					<a onclick="VotesQDown(<?php echo $row["qid"] ?>,0)">
		...
		<br>
		<h2>
			<?php echo $votescount ?> Answer<?php if ($votescount != 1) echo "s"; ?>
		</h2>
		<hr>
		...
		<table>
			<tr>
				<td class="VotesQA">
					<a onclick="VotesAUp(0,<?php echo $row["aid"] ?>)">
						<img src="img/vote-up.png">
					</a>
					<br>
			...
			<tr>
				<td></td>
				<td class="Answerer">
					answered by <?php echo $row["email"]?> at <?php echo $row["datetime"]?>
				</td>
			</tr>
		</table>
		<hr>
